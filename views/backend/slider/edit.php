                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <form action="" method="POST">
                            <div id="slideadmin">
                                <div class="hovereffect"><img id="hdd" class="img-responsive" src="<?php echo home.'/'. $getSlider->Slider_Image; ?>" alt="">
                        ...
                        <div class="tab-content">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="Slide_Name" class="form-control" placeholder="Tiêu đề" value="<?php echo $getSlider->Slider_Name; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="Link" class="col-sm-2 control-label">Đường dẫn </label>
                                    <div class="col-sm-10">
                                        <input type="text" name="Slide_Link" class="form-control" placeholder="Đường dẫn" value="<?php echo $getSlider->Slider_Link; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
